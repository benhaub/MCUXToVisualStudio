...
###############################################################################
# Author: Ben Haubrich                                                        #
# File: getMcuXpressoPaths.bash                                               #
# Date: January 23rd, 2021                                                    #
# Synopsis: Find the paths to MCUXpresso executables                          #
###############################################################################

source common.bash

help() {
  echo "Usage getMcuXpressoPaths.bash <pathToMcuXpressoInstallRoot>"
}
...
#For testing
#getMcuXpressoPaths /mnt/c/nxp/MCUXpressoIDE_11.3.1_5262
